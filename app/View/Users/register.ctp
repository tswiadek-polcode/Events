...
echo $this->form->input('birthday', array('type'=>'date', 'dateFormat'=>'YMD', 'minYear'=>date('Y')-30, 'maxYear'=>date('Y'), 'empty'=>array('- -')));
echo $this->form->input('password');
echo $this->form->input('privileges_id', array('value'=>'2', 'type'=>'hidden'));
